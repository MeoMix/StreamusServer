...
namespace Streamus_Web_API_Tests
{
  ...
  public class Helpers
  {
    ...
    public PlaylistItem CreateUnsavedPlaylistItem(string videoIdOverride = "", string titleOverride = "")
    {
      ...
      string title = titleOverride == string.Empty ? $"Video {randomVideoId}" : titleOverride;
      var playlistItem = new PlaylistItem(randomVideoId, "111", VideoType.YouTube, title, 999, "Author");
    ...
    {
      User user = _userManager.CreateUser(googlePlusId);
      return user;
    }
