...
namespace Streamus_Web_API_Tests.Routing_Tests
{
    ...
    public class PlaylistRoutingTest : StreamusTest
    {
        ...
        [Test]
        public void PUT_Should_route_to_PlaylistController_Update_method()
        {
        ...
        [Test]
        public void PATCH_UpdateTitle_Should_route_to_PlaylistController_UpdateTitle_method()
        {
            var request = new HttpRequestMessage(new HttpMethod("PATCH"), RoutePrefix + "UpdateTitle/");
            var config = new HttpConfiguration();
            ...
            route.Controller.Should().Be<PlaylistController>();
            route.Action.Should().Be("UpdateTitle");
        }

        [Test]
        public void GET_CreateCopyByShareCode_Should_route_to_PlaylistController_CreateCopyByShareCode_method()
        {
            var request = new HttpRequestMessage(HttpMethod.Get, RoutePrefix + "CreateCopyByShareCode/");
            var config = new HttpConfiguration();
