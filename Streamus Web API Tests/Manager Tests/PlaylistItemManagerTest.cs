...
namespace Streamus_Web_API_Tests.Manager_Tests
{
  ...
  public class PlaylistItemManagerTest : StreamusTest
  {
    ...
    public void CreateItem_NoVideoExists_VideoAndItemCreated()
    {
      ...
      PlaylistItem itemFromDatabase = _playlistItemManager.Get(playlistItem.Id);
    ...
    public void DeletePlaylistItem_NoOtherItems_MakesPlaylistEmpty()
    {
      ...
      _playlistItemManager.Delete(playlistItem.Id);

      bool exceptionEncountered = false;
      try
      {
        _playlistItemManager.Get(playlistItem.Id);
      }
    ...
    public void DeleteFirstPlaylistItem_OneOtherItemInPlaylist_LeaveSecondItemAndUpdatePointers()
    {
      ...
      _playlistItemManager.Delete(firstItem.Id);

      bool exceptionEncountered = false;
      try
      {
        _playlistItemManager.Get(firstItem.Id);
      }
      catch (ObjectNotFoundException)
      {
        exceptionEncountered = true;
